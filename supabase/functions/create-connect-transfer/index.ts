...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // safe to show -- this catch also sees raw Postgres errors from the
    // `if (error) throw error` checks above, which can leak column/
    // constraint names and were never meant for client eyes.
